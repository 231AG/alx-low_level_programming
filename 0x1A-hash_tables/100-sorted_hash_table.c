...
/**
 * shash_table_set - sets key and value in sorted hash table
...
/**
 * shash_table_print - print key/values of hash table in sorted order
 * @ht: hash table
 */
...
/**
 * shash_table_delete - frees and delete a hash table
 * @ht: hash table
 */
